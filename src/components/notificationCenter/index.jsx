...
import {MdExpandMore as Expand, MdExpandLess as ExpandLess} from 'react-icons/md';
		...
		<div className='notification-center'>
			...
			<div className='nc-footer'>
				<h3 className="caption">
					<span>IOS and Android APPS <br/> 
					<span className='black-bg'>Comming Soon...</span></span>
				</h3>
			</div>
		</div>
	);
